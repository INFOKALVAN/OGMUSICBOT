...
import config
from INDUMUSIC import LOGGER, app
from INDUMUSIC.core.mongo import mongodb
from INDUMUSIC.misc import db
from INDUMUSIC.platforms.Youtube import YouTubeAPI, youtube_search_multi
...
ARTIST_LANG = {
    "hindi": [
        ...
        "indu shekhar", "amit trivedi", "pritam", "shankar ehsaan loy",
    ],
    "punjabi": [
...
async def auto_play_next(
    ...
    """
    from INDUMUSIC.utils.database import get_lang
    ...
    try:
        ...
        from INDUMUSIC.utils.database import is_active_chat as _verify_stream_active
        ...
        try:
            ...
            from INDUMUSIC.utils.database import is_on_off
