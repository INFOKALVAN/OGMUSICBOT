...
from INDUMUSIC import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from INDUMUSIC.core.call import INDU
from INDUMUSIC.utils import seconds_to_min, time_to_seconds
from INDUMUSIC.utils.channelplay import get_channeplayCB
from INDUMUSIC.utils.decorators.language import languageCB
from INDUMUSIC.utils.decorators.play import PlayWrapper
from INDUMUSIC.utils.errors import capture_err, capture_callback_err
from INDUMUSIC.utils.formatters import formats
from INDUMUSIC.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from INDUMUSIC.utils.logger import play_logs
from INDUMUSIC.utils.stream.stream import stream
...
@app.on_callback_query(filters.regex("InduPlaylists") & ~BANNED_USERS)
@languageCB
@capture_callback_err
