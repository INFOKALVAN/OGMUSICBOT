...
from INDUMUSIC.utils.database import group_assistant
from INDUMUSIC.utils.admin_filters import admin_filter
...
async def vc_info(client, message: Message):
    ...
    try:
        assistant = await group_assistant(INDU, chat_id)
