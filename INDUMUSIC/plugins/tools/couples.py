...
from INDUMUSIC.core.dir import COUPLE_DIR
from INDUMUSIC.mongo.couples_db import get_couple, save_couple


ASSETS = Path("INDUMUSIC/assets")
...
async def generate_image(chat_id: int, uid1: int, uid2: int, date: str) -> str:
    base = Image.open(ASSETS / "indu/couple.png").convert("RGBA")
