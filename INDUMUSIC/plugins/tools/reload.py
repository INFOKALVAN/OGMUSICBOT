...
from INDUMUSIC.utils.database import get_assistant, get_authuser_names, get_cmode
from INDUMUSIC.utils.decorators import AdminActual, language
from INDUMUSIC.utils.formatters import alpha_to_int, get_readable_time
...
async def restart_bot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await INDU.force_stop_stream(message.chat.id)
    except:
        pass
