...
from INDUMUSIC.utils.decorators.admins import ActualAdminCB
from INDUMUSIC.utils.decorators.language import language, languageCB
from INDUMUSIC.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from INDUMUSIC.utils.inline.start import private_panel
...
async def authusers_mar(client, callback: CallbackQuery, _):
    ...
    if command == "AUTHLIST":
        ...
        if not _authusers:
            ...
            from INDUMUSIC.utils.colored_buttons import styled_button
            upl = [[
