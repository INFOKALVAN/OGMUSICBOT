...
from INDUMUSIC.misc import _boot_
from INDUMUSIC.plugins.sudo.sudoers import sudoers_list
...
from INDUMUSIC.utils.decorators.language import LanguageStart
from INDUMUSIC.utils.formatters import get_readable_time
from INDUMUSIC.utils.inline.help import first_page
from INDUMUSIC.utils.inline.start import private_panel, start_panel
...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:3] == "inf":
            ...
            from INDUMUSIC.utils.colored_buttons import styled_button, buttons_to_inline_markup
