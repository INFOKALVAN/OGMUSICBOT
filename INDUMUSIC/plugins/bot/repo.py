...
async def show_repo(_, msg):
    buttons = [
        ...
        [
            styled_button("👑 ᴏᴡɴᴇʀ", url="https://t.me/ItsMeInduBots", style="primary"),
            styled_button("💬 ꜱᴜᴘᴘᴏʀᴛ", url="https://t.me/ItsMeInduBots", style="primary"),
        ],
        [
            styled_button("🛠️ ꜱᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ", url="https://t.me/ItsMeInduBots", style="primary"),
            styled_button("🎵 ɢɪᴛʜᴜʙ", url="https://github.com/ItsMeIndu0/InduMusic", style="primary"),
        ],
    ]
